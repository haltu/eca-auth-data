...
"""
  ...
  def really_do_this(self, d, a):
    ...
    # TODO: get_or_create group before this!
    att,_ = Attendance.objects.get_or_create(user=user, school=school, role=self.role_names[d['role']], group=None, source=self.source)
